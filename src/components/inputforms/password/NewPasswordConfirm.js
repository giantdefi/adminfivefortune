...
import { setNewPasswordConfirm } from 'redux/reducers/AuthReducer'
//-------------------------------------------------------
...
export default function Password() {
    ...
    const { newPasswordConfirm } = useSelector((state) => state.AuthReducer)
    ...
    useEffect(() => {
        if (formError && formError.path === 'newPasswordConfirm') {
    ...
    return (
        <>
            ...
            <div className="flex justify-between text-white mt-6">
                <p className="mb-2 "> Password Confirmation   </p>
                {!showPassword ?
            ...
            />
           {formError && formError.path === 'newPasswordConfirm' &&
