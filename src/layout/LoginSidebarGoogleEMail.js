...
// replace firebase link using header link manually
    ...
    useEffect(() => {
      ...
      loadScript(src)
        .then(() => {
          ...
          client_id: "600769979799-u6j5l1gtk5cclbpteo3pbv2f97le882k.apps.googleusercontent.com",
...
<div class="max-w-sm mx-auto">
  <label for="website-admin" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">You Email : </label>
  <div class="flex">
...
<div>
    ...
    <label  className="block text-sm font-medium text-gray-900 dark:text-white mb-1">Enter Password : </label>
    {!showPassword ?
  ...
  text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">  Login</button>
    ...
    <p className="text-sm mb-6 mt-4  mx-auto">OR Login with Google Account :</p>
    </div>


        {!isLogin && <div id="signInDiv" className="text-gray-900 mx-auto" ></div> }
        {isLogin && <>
        <div className="border px-4">
        <div className="justify-between flex">
           <p className="text-[12px]">You are Login as : </p> <p className="text-[12px]">{name}</p>
           </div>
           <div className="justify-between flex">
           <p className="text-[12px]">Your email : </p> <p className="text-[12px]">{email}</p>
           </div>
