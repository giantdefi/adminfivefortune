...
import {setAdminPackageArray, setAllowRelaodPAckage, setItemToEdit, setStatsSelectedPackage } from 'redux/reducers/PackageReducer'
...
export default function Users() {
  ...
  const handleActiveUsers = (pack) => {
    dispatch(setStatsSelectedPackage(pack))
...
<div className="min-h-screen  w-full pb-20 px-10">
 ...
 <div className="mb-12 grid gap-y-10 gap-x-6 md:grid-cols-2 xl:grid-cols-4 mt-10 w-full ">
     <button onClick={()=>router.push('/admin/reg-users')} className="relative flex flex-col bg-clip-border border rounded-xl bg-white text-gray-700 shadow-md">
        ...
        <button onClick={()=>handleActiveUsers('X')} className="relative flex flex-col bg-clip-border border rounded-xl bg-white text-gray-700 shadow-md">
        ...
        <button  onClick={()=>router.push('/admin/wd-request')} className="relative flex flex-col bg-clip-border border rounded-xl bg-white text-gray-700 shadow-md">
 ...
 <button onClick={()=>handleActiveUsers(item.package_name)} className="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md" key={index}>
          <div className="bg-clip-border mx-4 rounded-xl overflow-hidden bg-gradient-to-tr from-green-600 to-green-400 text-white shadow-green-500/40 shadow-lg absolute -mt-4 grid h-16 w-16 place-items-center">
