  ...
  <>
    ...
    <body className="bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-100 ">
      ...
      <section className="relative min-h-screen bg-gray-400 dark:bg-[#111] animated fadeIn">
       ...
       <section className="min-h-screen bg-cover bg-center text-white py-20 " style={{ backgroundImage: 'url(/assets/img/bg/apartment-bg.webp)' }}>
        <div className="container mx-auto text-center ">
        <h1 className="text-5xl font-bold">FIVEFORTUNE <span className="text-3xl">ADMINISTRATOR PAGE</span> </h1>
